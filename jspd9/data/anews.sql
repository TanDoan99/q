...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2020 at 12:02 PM
...
INSERT INTO `news` (`id`, `name`, `description`, `image`, `detail`, `created_at`, `cat_id`) VALUES
(1, 'Thị trấn truyền thống Uchiko – Nhật Bản', 'Thị trấn truyền thống của Uchiko được bao quanh bởi vẻ đẹp tự nhiên', 'hinh1.jpg', '', '2019-12-31 17:20:50', 1),
...
--
ALTER TABLE `contact`
MODIFY `id_contact` int(6) NOT NULL AUTO_INCREMENT;
--
